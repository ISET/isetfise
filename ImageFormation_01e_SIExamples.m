...
% 
% There are four example PSF. One is a simple pillbox (averaging) PSF. The second 
% is a simple sharpening filter (difference of Gaussians). The third is a series 
% of Gaussian blur filters with a spread that changes with wavelength.  The fourth 
% is an asymmetric Gaussian, with a wider x- than y-dimension.
% 
...
% 
% We create a point spread for each wavelength, 400:10:700. We write out a file 
% that contains the point spread functions using ieSaveSIDataFile.
...
% Now call the routine with these parameters to make a Gaussian PSF
