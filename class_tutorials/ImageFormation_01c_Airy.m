...
% Lord Airy <https://en.wikipedia.org/wiki/Airy_disk (George Biddell Airy)>. This 
% script exposes the code used to calculate and plot the Airy disk for diffraction 
% limited optics.
% 
...
%% 
% Frequency units here are cycles/micron. The spatial frequency support runs 
% from -Nyquist:Nyquist. With this support, the Nyquist frequency is actually 
% the highest (peak) frequency value. There are two samples per Nyquist, so the 
% sample spacing is 
% 
